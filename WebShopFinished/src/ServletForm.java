...
String firstPartHtml = "<html>\n" +
        ...
        "    <a class=\"navbar-brand\" href=\"/NewWeb_war_exploded/editperson.jsp\">AB\\Design</a>\n" +
        "    <button class=\"navbar-toggler\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarNavAltMarkup\" aria-controls=\"navbarNavAltMarkup\" aria-expanded=\"false\" aria-label=\"Toggle navigation\">\n" +
        "        <span class=\"navbar-toggler-icon\"></span>\n" +
        "    </button>\n" +
        "    <div class=\"collapse navbar-collapse\" id=\"navbarNavAltMarkup\">\n" +
        "        <div class=\"navbar-nav\">\n" +
        "            <a class=\"nav-item nav-link\" href=\"/NewWeb_war_exploded/editperson.jsp\">Home <span class=\"sr-only\">(current)</span></a>\n" +
        "            <a class=\"nav-item nav-link\" href=\"/NewWeb_war_exploded/coustomers.jsp\">Customers</a>\n" +
        "            <a class=\"nav-item nav-link\" href=\"/NewWeb_war_exploded/products.jsp\">Products</a>\n" +
        "            <a class=\"nav-item nav-link\" href=\"/NewWeb_war_exploded/sales.jsp\">Sales</a>\n" +
        "        </div>\n" +
        "    </div>\n" +
        "</nav>\n" +
        "\n" +
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (request.getParameter("first_name").equals("") && request.getParameter("last_name").equals("") && request.getParameter("address").equals("") && request.getParameter("country").equals("")) {
                ...
                Query query = session.createQuery("update Customers set firstName = :name,lastName = :lastname,address = :address, country = :country where id ="+ request.getParameter("id"));
                ...
                out.println("<p><a href=\"/NewWeb_war_exploded/coustomers.jsp\" class=\"btn btn-dark\" role=\"button\">Go Back</a></p>\n" +
                        "            </div>\n" +
                        "</div>");
