...
<div class="container">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="/WebShopFinished/index.jsp"></a>
    ...
    <%
    try {
        if (request.getParameter("generate").equals("")){

        }else{
            Main.createSampleSales();
            Main.createSampleCustomers();
            Main.createSampleProducts();
        }
    }catch (Exception e){
    ...
    <div class="jumbotron"><h1>Home</h1>

    </div>
    <div class="divider">
        <hr>
    </div>
    <a class="btn btn-dark btn-lg btn-block"href="/WebShopFinished/index.jsp?generate=1">Generate Sample Values</a>
</div>
